...
import { getOrganizationByWhatsAppNumber, getUserByPhone, addTicket, createUserInFirestore, getOpenTicketsByUserId, addConversation, addAutoGeneratedUser } from '@/lib/firestore';
